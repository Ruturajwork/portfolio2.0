...
import HtmlHover from "../../assets/icons/html1.png";

import ReactIcon from "../../assets/icons/react.png";
import ReactHover from "../../assets/icons/react1.png";

import Docker from "../../assets/icons/Docker.png";
import DockerHover from "../../assets/icons/Docker1.png";

import Css from "../../assets/icons/Css.png";
import CssHover from "../../assets/icons/Css1.png";

import Javascript from "../../assets/icons/javascript.png";
import JavascriptHover from "../../assets/icons/javascript1.png";

import Mongodb from "../../assets/icons/Mongodb.png";
import MongodbHover from "../../assets/icons/Mongodb1.png";

import Node from "../../assets/icons/Node.png";
import NodeHover from "../../assets/icons/Node1.png";

import Npm from "../../assets/icons/Npm.png";
import NpmHover from "../../assets/icons/Npm1.png";

import Php from "../../assets/icons/Php.png";
import PhpHover from "../../assets/icons/Php1.png";

import Redux from "../../assets/icons/Redux.png";
import ReduxHover from "../../assets/icons/Redux1.png";

import Sass from "../../assets/icons/Sass.png";
import SassHover from "../../assets/icons/Sass1.png";

import Sql from "../../assets/icons/Sql.png";
import SqlHover from "../../assets/icons/Sql1.png";

import Yarn from "../../assets/icons/Yarn.png";
import YarnHover from "../../assets/icons/Yarn1.png";
...
const skills = [
  { id: 1, name: "HTML", icon: Html, hover: HtmlHover },
  { id: 2, name: "React", icon: ReactIcon, hover: ReactHover },
  { id: 3, name: "Docker", icon: Docker, hover: DockerHover },
  { id: 4, name: "CSS", icon: Css, hover: CssHover },
  { id: 5, name: "JavaScript", icon: Javascript, hover: JavascriptHover },
  { id: 6, name: "MongoDB", icon: Mongodb, hover: MongodbHover },
  { id: 7, name: "Node JS", icon: Node, hover: NodeHover },
  { id: 8, name: "NPM", icon: Npm, hover: NpmHover },
  { id: 9, name: "PHP", icon: Php, hover: PhpHover },
  { id: 10, name: "Redux", icon: Redux, hover: ReduxHover },
  { id: 11, name: "Sass", icon: Sass, hover: SassHover },
  { id: 12, name: "SQL", icon: Sql, hover: SqlHover },
  { id: 13, name: "Yarn", icon: Yarn, hover: YarnHover },
];

// ================= COMPONENT =================

function CardComponent() {
  // Preload hover images (prevents lag)
  useEffect(() => {
